...
controls.addEventListener('dragstart', function (event) {
    (event.object as THREE.Mesh<THREE.BoxGeometry, THREE.MeshPhongMaterial>).material.opacity = 0.33
})
controls.addEventListener('dragend', function (event) {
    (event.object as THREE.Mesh<THREE.BoxGeometry, THREE.MeshPhongMaterial>).material.opacity = 1
})
