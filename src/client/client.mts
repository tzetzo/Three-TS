...
fbxLoader.load(
    ...
    (object) => {
        // object created in cm, but we need to convert to meters
...
const setAction = (toAction: THREE.AnimationAction) => {
    // prevent stop & play if same action is already playing
    if (toAction != activeAction) {
        lastAction = activeAction
        activeAction = toAction
        // lastAction.stop()
        // makes the transition between the different animations smooth
