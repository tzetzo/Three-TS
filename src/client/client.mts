...
meshBasicMaterialFolder.addColor(data, 'color').onChange(() => { material.color.setHex(data.color) })
meshBasicMaterialFolder.add(material, 'wireframe')
// meshBasicMaterialFolder.add(material, 'wireframeLinewidth', 0, 10) // doesnt exist anymore
...
function updateMaterial() {
    material.side = Number(material.side) as THREE.Side // comes out of the GUI as string but number needed
